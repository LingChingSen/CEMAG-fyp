...
import 'package:fyp_cemag/view/registrationscreen.dart';
import 'user.dart';
...
audio();
  ...
  Future<void> _onLogin() async {
    ...
    http.post(
        Uri.parse(
            "https://crimsonwebs.com/s271738/cemag/php/login_user.php"),
      ...
      if (response.body == "failed") {
        ...
        Fluttertoast.showToast(
            msg: "Please view guidelines if you are a new user.",
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.TOP,
...
void audio(){
 AssetsAudioPlayer.newPlayer().open(
  ...
  void _resetPassword(String emailreset) {
    http.post(
        Uri.parse(
            "https://crimsonwebs.com/s271738/cemag/php/reset_user.php"),
