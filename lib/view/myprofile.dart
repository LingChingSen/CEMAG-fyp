...
class _MyProfileState extends State<MyProfile> {
  ...
  void _onSaveProfile() {
    ...
    if (_username.isEmpty || _age.isEmpty) {
            ...
            actions: [
              TextButton(
                ...
                onPressed: () {
                  ...
                  _onSaveProfileEdit(_username, _age);
                },
              ),
              TextButton(
                  child: Text("Cancel",
  ...
  void _onSaveProfileEdit(String _username, String _age) {
    http.post(
        Uri.parse(
            "https://crimsonwebs.com/s271738/cemag/php/updateprofile.php"),
        body: {
  ...
  void _onSavePasswordEdit(String _passworda, String _passwordb) {
    http.post(
        Uri.parse(
            "https://crimsonwebs.com/s271738/cemag/php/updatepassword.php"),
        body: {
          "email": widget.user.email,
          "password": _passworda,
