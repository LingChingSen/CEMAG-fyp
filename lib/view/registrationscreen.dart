...
class _RegistrationScreenState extends State<RegistrationScreen> {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image.asset('assets/images/cemag.png', scale: 2),
            ),
            SizedBox(height: 3),
            Text('Sign Up',
              ...
              child: Padding(
                ...
                child: Column(children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                        labelText: 'Age', icon: Icon(Icons.attribution_outlined)),
                  ),
                  TextField(
            ...
            GestureDetector(
                child:
                    Text("Already Sign Up?", style: TextStyle(fontSize: 13)),
  ...
  void _onRegister() {
    ...
    String _age = _ageController.text.toString();
            ...
            actions: [
              TextButton(
                ...
                onPressed: () {
                  ...
                  _registerUser(_username, _email, _passworda, _age);
                },
              ),
              TextButton(
                  child: Text("Cancel"),
  ...
  Future<void> _registerUser(
      String username, String email, String password, String age) async {
    pr = ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: true, showLogs: true);
    await pr.show();
    http.post(
        Uri.parse(
            "https://crimsonwebs.com/s271738/cemag/php/register_user.php"),
        body: {
          "username": username,
          "age": age,
          "email": email,
